...
//        initCharts: function (pageview, visitor) {
//            if (!jQuery.plot) {
//                return;
//            }
...
//                $('<div id="tooltip" class="chart-tooltip"><div class="">' + x + '<\/div><div class="label label-success">Complete: ' + y/10 + '%<\/div><div class="label label-danger">Incomplete: ' + (y-10)/10 + '<\/div><\/div>').css({
//                    position: 'absolute',
//                    display: 'none',
//                    top: y - 100,
//                    width: 120,
